...
// Every glyph a row may carry: the activity icons plus detox's wind under {@link DETOX}'s key, which the editor never cycles to.
const GLYPHS: Record<string, string> = { ...ICONS, [DETOX.iconKey]: WIND }
